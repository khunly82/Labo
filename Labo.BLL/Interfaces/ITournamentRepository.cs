...
namespace Labo.BLL.Interfaces
{
    public interface ITournamentRepository : IRepository<Tournament>
    {
        ...
        IEnumerable<Tournament> FindWithPlayersByCriteriaOrderByCreationDateDesc(string? name, TournamentCategory? category, IEnumerable<TournamentStatus>? statuses, DateTime? from, bool wonenOnly = false, int offset = 0, int limit = 10);
